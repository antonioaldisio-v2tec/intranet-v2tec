# Intranet V2Tec (volto-v2tec-intranet)
...
Add `volto-v2tec-intranet` to your `package.json`.

```json
"dependencies": {
    "volto-v2tec-intranet": "*"
}
```

Add `volto-v2tec-intranet` to your `volto.config.js`.

```javascript
const addons = ['volto-v2tec-intranet'];
```

If this package provides a Volto theme, and you want to activate it, then add the following to your `volto.config.js`.

```javascript
const theme = 'volto-v2tec-intranet';
```
...
yo @plone/volto my-volto-project --addon volto-v2tec-intranet
cd my-volto-project
```
