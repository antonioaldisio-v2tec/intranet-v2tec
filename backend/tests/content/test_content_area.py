...
class TestArea:
    ...
    def test_create(self, area_payload, role, can_create):
        """Apenas Manager e Site Administrator podem criar uma nova Área."""
        payload = {**area_payload, "id": role.lower().replace(" ", "-")}
